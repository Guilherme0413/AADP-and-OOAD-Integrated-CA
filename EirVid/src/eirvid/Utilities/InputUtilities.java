 ...
 */
/**
 * Common Input Tasks Includes: KEYBOARD INPUT UTILITIES getUserText getUserInt
 * - with a range getUserInt - with a minimum getUserDouble - with a range
 *
 *
...
public class InputUtilities {
    ...
    public static String getUserEmail(String prompt) {
        ...
        do {
            //if input is not email, ask again
    ...
    /**
     * Prompt user with a message to enter an integer above a given value repeat
     * prompt until user enters valid value
     *
    ...
    /**
     *
     * Displays a prompt and requests a decimal from user; if a non-decimal is
     * entered display error message and ask again
     *
